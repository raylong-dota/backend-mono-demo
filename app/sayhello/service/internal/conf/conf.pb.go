...
type Data struct {
	...
	Helloworld    *Data_Helloworld       `protobuf:"bytes,3,opt,name=helloworld,proto3" json:"helloworld,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data) GetHelloworld() *Data_Helloworld {
	if x != nil {
		return x.Helloworld
	}
	return nil
...
func (x *Data_Helloworld) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Helloworld) ProtoMessage() {}

func (x *Data_Helloworld) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Helloworld.ProtoReflect.Descriptor instead.
func (*Data_Helloworld) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_Helloworld) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xbc\x03\n" +
	"\x04Data\x125\n" +
	"\bdatabase\x18\x01 \x01(\v2\x19.kratos.api.Data.DatabaseR\bdatabase\x12,\n" +
	"\x05redis\x18\x02 \x01(\v2\x16.kratos.api.Data.RedisR\x05redis\x12;\n" +
	"\n" +
	"helloworld\x18\x03 \x01(\v2\x1b.kratos.api.Data.HelloworldR\n" +
	"helloworld\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\n" +
	"Helloworld\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addrB\x1dZ\x1bsayhello/internal/conf;confb\x06proto3"
...
var file_internal_conf_conf_proto_goTypes = []any{
	...
	(*Data_Helloworld)(nil),     // 7: kratos.api.Data.Helloworld
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.helloworld:type_name -> kratos.api.Data.Helloworld
